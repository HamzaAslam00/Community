                    ...
                    <div class="toggle-wrap nk-block-tools-toggle">
                        ...
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <li class="nk-block-tools-opt"><a href="#" class="btn btn-primary btn-sm" data-act="ajax-modal" data-method="get" data-action-url="{{ route('admin.registration-pages.create') }}" data-title="Add New Page"><em class="icon ni ni-plus"></em><span>Add Page</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(function() {
            options = {
                ...
                ajax: '{{ route('admin.registration-pages-datatable') }}',
                processing: true,
                serverSide: true,
                scrollX: false,
                autoWidth: true,
